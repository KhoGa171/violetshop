...
@section('title','VIOLET || HOME PAGE')
                            ...
                            <div class="single-list">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 no-padding">
                                    <div class="content">
                                        ...
                                        <p class="price with-discount">{{number_format($product->discount)}}đ</p>
                                    </div>
                                </div>
                                </div>
                            </div>
...
<div class="col-lg-6 col-12 padding-left">
    <div class="content">
        <div class="heading-block">
            ...
            $after_discount=($product->price-($product->price*$product->discount)/100)
            @endphp
            <h1 class="price">{{number_format($after_discount)}}đ <s>{{number_format($data->price)}}đ</s></h1>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="quickview-content">
                            ...
                            <h3>
                                @if($product->discount)
                                <small><del class="text-muted">{{number_format($product->price)}}đ</del></small>
                                @endif
