...
@endsection
@section('title','VIOLET || PRODUCT DETAIL')
										...
										<div class="product-des">
											...
											<div class="short">
												...
												<p class="price">
													...
													<s>{{number_format($product_detail->price)}}đ</s> 
													@endif
												</p>
											...
											<div class="product-buy">
												...
												<p class="cat">Thể loại :<a href="{{route('product-cat',$product_detail->cat_info['slug'])}}">{{$product_detail->cat_info['title']}}</a></p>
												@if($product_detail->sub_cat_info)
												<p class="cat mt-1">Thể loại phụ:<a href="{{route('product-sub-cat',[$product_detail->cat_info['slug'],$product_detail->sub_cat_info['slug']])}}">{{$product_detail->sub_cat_info['title']}}</a></p>
												@endif
												<p class="availability">Số lượng còn lại: @if($product_detail->stock>0)<span class="badge badge-success">{{$product_detail->stock}}</span>@else <span class="badge badge-danger">{{$product_detail->stock}}</span>  @endif</p>
											</div>
											<!--/ End Product Buy -->
										</div>
									</div>
										...
										<div class="product-info">
											<div class="nav-main">
												...
												<ul class="nav nav-tabs" id="myTab" role="tablist">
													<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#description" role="tab">Miêu tả</a></li>
														...
														<div class="row">
															<div class="col-12">
																...
																<p class="text-center p-5">
																	Bạn cần <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Đăng nhập</a> OR <a style="color:blue" href="{{route('register.form')}}">Đăng ký</a>
																...
																<div class="ratting-main">
																	<div class="avg-ratting">
																		...
																		@endphp --}}
																		<h4>{{ceil($product_detail->getReview->avg('rate'))}} <span>(Sao)</span></h4>
																		<span>Đang có {{$product_detail->getReview->count()}} đánh giá</span>
																	</div>
                                    ...
                                    <div class="product-img">
										...
										<div class="button-head">
											...
											<div class="product-action-2">
												<a data-toggle="modal" data-target="#{{$data->id}}" title="Quick View" href="#">Add to cart</a>
											</div>
										</div>
                                    </div>
